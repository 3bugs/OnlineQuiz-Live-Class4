...
import com.example.onlinequizliveclass4.model.Question;
import com.example.onlinequizliveclass4.model.Questions;
                    ...
                    new AlertDialog.Builder(QuizActivity.this)
                            ...
                            .setPositiveButton("ส่ง", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    WebServices.setUserGuesses(User.loggedInUser.userId, mQuizId, mQuestions.getList(),
